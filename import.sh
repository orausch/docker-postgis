...
SQL "\\copy accidents(id,jahr,kanton,monat,tag,stunde,accident,surface_asphalt,surface_concrete,surface_cobble,surface_dirt,surface_grass,surface_gravel,surface_paved,dist_tl,lanes,speed,capacity,trucks,cars,usage) TO '/var/lib/postgresql/data/out.csv' DELIMITER ',' CSV HEADER;"
